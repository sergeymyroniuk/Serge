...
public class Sixteen extends JFrame {
    ...
    public Sixteen(String s) {
        super(s);
        setLayout(new FlowLayout());
        l1 = new JLabel("Введите шестнадцатеричное число:");
        ...
        b3 = new JButton("Перевод в восьмеричную систему счисления");
        b4 = new JButton("Очистить");
        b6 = new JButton("Перевод чисел из двоичной системы в любую систему счисления");
        b7 = new JButton("Перевод чисел из восьмеричной системы в любую систему счисления");
    ...
    public class eHandler implements ActionListener{
        public void actionPerformed(ActionEvent e) {
            try {
                if (e.getSource() == b1) {
                    b = Integer.toBinaryString(Integer.parseInt(t1.getText(), 16));
                    a = "Двоичная система счисления: " + b;
                    l2.setText(a);
                }
                if (e.getSource() == b2) {
                    i = Integer.parseInt(t1.getText(),16);
                    a = "Десятичная система счисления: " + i;
                    l2.setText(a);
                }
                if (e.getSource() == b3) {
                    x = Integer.toOctalString(Integer.parseInt(t1.getText(), 16));
                    a = "Восьмеричная система счисления: " + x.toUpperCase();
                    l2.setText(a);
                }
                if (e.getSource() == b4) {
                    t1.setText(null);
