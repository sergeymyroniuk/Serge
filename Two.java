...
public class Two extends JFrame {
    ...
    public Two(String s) {
        ...
        l1 = new JLabel("Введите двоичное число:");
        b5 = new JButton("Перевод чисел из десятичной системы в любую систему счисления");
        b1 = new JButton("Перевод в десятичную систему счисления");
    ...
    public class eHandler implements ActionListener{
        public void actionPerformed(ActionEvent e) {
            try {
                if (e.getSource() == b1) {
                    i = Integer.parseInt(t1.getText(),2);
                    a = "Десятичная система счисления: " + i;
                    l2.setText(a);
                }
                if (e.getSource() == b2) {
                    x = Integer.toOctalString(Integer.parseInt(t1.getText(), 2));
                    a = "Восьмеричная система счисления: " + x;
                    l2.setText(a);
                }
                if (e.getSource() == b3) {
                    x = Integer.toHexString(Integer.parseInt(t1.getText(), 2));
